...
public class DoubleSetting extends SettingBase<Double> {
    ...
    public static class Builder extends SettingBase.Builder<me.x150.coffee.feature.config.DoubleSetting.Builder, Double, DoubleSetting> {
        ...
        public me.x150.coffee.feature.config.DoubleSetting.Builder precision(int precision) {
            this.precision = precision;
            return this;
        }

        public me.x150.coffee.feature.config.DoubleSetting.Builder min(double min) {
            this.min = min;
            return this;
        }

        public me.x150.coffee.feature.config.DoubleSetting.Builder max(double max) {
            this.max = max;
            return this;
        }
