...
public class HomeScreen extends ClientScreen implements FastTickable {
    ...
    void initWidgets() {
        ...
        RoundButton alts = new RoundButton(bg, rightPad - (padding + 60) * 4, centerWidgetsY, 60, 20, "Alts", () -> CoffeeClientMain.client.setScreen(/*AltManagerScreen.instance()*/new TestScreen()));
